...
public:
  ...
  const char *name() override { return "opengl.device.fltk.org"; }
  int print(Fl_Widget *w) override {
  ...
  Fl_RGB_Image* rectangle_capture(Fl_Widget *widget, int x, int y, int w, int h) override {
