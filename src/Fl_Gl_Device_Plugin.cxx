...
public:
  ...
  virtual const char *name() FL_OVERRIDE { return "opengl.device.fltk.org"; }
  virtual int print(Fl_Widget *w) FL_OVERRIDE {
  ...
  virtual Fl_RGB_Image* rectangle_capture(Fl_Widget *widget, int x, int y, int w, int h) FL_OVERRIDE {
