//
// "$Id: Fl_Menu_add.cxx,v 1.9.2.3 1999/07/12 11:59:03 mike Exp $"
//
...
static Fl_Menu_Item* insert(
  ...
  if (array == local_array && size >= (local_array_alloc - 1)) {
...
//
// End of "$Id: Fl_Menu_add.cxx,v 1.9.2.3 1999/07/12 11:59:03 mike Exp $".
//
