...
private:
  ...
  static Fl_Color message_color_;
  static Fl_Color message_color_default_;
  static Fl_Color message_labelcolor_;
  static Fl_Color message_labelcolor_default_;
  static Fl_Color message_button_color_;
  static Fl_Color message_button_color_default_;
  static Fl_Color message_button_labelcolor_;
  static Fl_Color message_button_labelcolor_default_;
  static Fl_Font message_button_font_;
  static Fl_Font message_button_font_default_;
  static Fl_Fontsize message_button_fontsize_;
  static Fl_Fontsize message_button_fontsize_default_;
...
*/
  static void message_color(Fl_Color c) {
    message_color_ = c;
  }
...
*/
  static void message_color_default(Fl_Color c) {
    message_color_default_ = c;
  }
...
*/
  static void message_labelcolor(Fl_Color c) {
    message_labelcolor_ = c;
  }
...
*/
  static void message_labelcolor_default(Fl_Color c) {
    message_labelcolor_default_ = c;
  }
...
*/
  static void message_button_color(Fl_Color c) {
    message_button_color_ = c;
  }
...
*/
  static void message_button_color_default(Fl_Color c) {
    message_button_color_default_ = c;
  }
...
*/
  static void message_button_labelcolor(Fl_Color c) {
    message_button_labelcolor_ = c;
  }
...
*/
  static void message_button_labelcolor_default(Fl_Color c) {
    message_button_labelcolor_default_ = c;
  }
...
*/
  static void message_button_font(Fl_Font f) {
    message_button_font_ = f;
  }
...
*/
  static void message_button_font_default(Fl_Font f) {
    message_button_font_default_ = f;
  }
...
*/
  static void message_button_fontsize(Fl_Fontsize s) {
    message_button_fontsize_ = s;
  }
...
*/
  static void message_button_fontsize_default(Fl_Fontsize s) {
    message_button_fontsize_default_ = s;
  }
