...
protected:
  ...
  virtual void line_style(int style, int width, char *dashes=0) FL_OVERRIDE;
  ...
  virtual void font(int f, int s) FL_OVERRIDE;
  virtual Fl_Font font() FL_OVERRIDE;
  virtual void draw(const char *str, int n, int x, int y) FL_OVERRIDE;
  virtual void draw(const char*, int, float, float) FL_OVERRIDE;
  virtual void draw(int, const char*, int, int, int) FL_OVERRIDE;
  ...
  virtual void draw_bitmap(Fl_Bitmap *bm,int XP, int YP, int WP, int HP, int cx, int cy) FL_OVERRIDE;
  virtual void draw_image(const uchar* buf, int x, int y, int w, int h, int d, int l) FL_OVERRIDE;
  virtual void draw_image(Fl_Draw_Image_Cb cb, void* data, int x, int y, int w, int h, int d) FL_OVERRIDE;
  virtual void draw_image_mono(const uchar* buf, int x, int y, int w, int h, int d, int l) FL_OVERRIDE;
  virtual void draw_image_mono(Fl_Draw_Image_Cb cb, void* data, int x, int y, int w, int h, int d) FL_OVERRIDE;
