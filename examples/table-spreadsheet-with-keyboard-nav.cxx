...
protected:
  virtual void draw_cell(TableContext context,int=0,int=0,int=0,int=0,int=0,int=0) FL_OVERRIDE;
...
public:
  ...
  virtual void rows(int val) FL_OVERRIDE {
    Fl_Table::rows(val);
  }
  // Change number of columns
  virtual void cols(int val) FL_OVERRIDE {
    Fl_Table::cols(val);
  }
  // Get number of rows
  inline int rows() {
