...
// generated by Fast Light User Interface Designer (fluid) version %.4f\n\n";
  ...
  *b = 0;
  ...
  if (Fluid.proj.i18n_type && !loc_include.empty()) {
    ...
    if (loc_include[0] != '<' && loc_include[0] != '\"')
      ...
      write_c("#%sinclude %s\n", indent(), loc_include.c_str());
    if (Fluid.proj.i18n_type == FD_I18N_POSIX) {
    ...
    if (Fluid.proj.i18n_type == FD_I18N_GNU && Fluid.proj.i18n_gnu_static_function[0]) {
