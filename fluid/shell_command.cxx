...
// TODO:   implement storage for both types
// TODO:   indicate storage location in command list widget
// TODO:   update project dirty flag is item with project storage changed
...
// if FLUID is in build/Xcode/bin/Debug/fluid.app/Contents/MacOS/fluid for example,
// we can use build/Xcode/fltk-config
// if we build with cmake and Makefiles, the app path is
//  build/Makefiles/bin/fluid.app/Contents/MacOS/fluid
// if we build with cmake and Makefiles on Linux, the app path is
//  build/Makefiles/bin/fluid
// where build/*/ is of course user definable
//
// If we build with autoconf, it's entirely different
//
// If we build on Windows with VC, the path with cmake is something with out/bin/debug/ IIRC
//
