...
// FLUID comes with default shell commands to compile the current project file,
// build the the project (compile and link), and run the project. This is
// accomplished by calling `fltk-config` on the files generated by FLUID.
//
// If the user wants more complex commands, he can add or modify them in the
// "Shell" preferences panel. Modified shell commands are saved with the .fl
// file.
