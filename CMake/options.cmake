...
if(UNIX)
  ...
  if(FLTK_USE_WAYLAND)
    ...
    if(EXISTS ${PROTOCOLS}/staging/xdg-toplevel-drag/xdg-toplevel-drag-v1.xml)
      set(HAVE_XDG_TOPLEVEL_DRAG 1)
      message(STATUS "Found dev files for Wayland protocol 'XDG toplevel drag'")
    else()
      set(HAVE_XDG_TOPLEVEL_DRAG 0)
    endif()
    if(FLTK_BACKEND_X11)
      include(FindX11)
    endif()
